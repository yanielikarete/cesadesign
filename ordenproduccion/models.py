...
class OrdenProduccion(models.Model):
    ...
    area_ebanisteria = models.BooleanField(blank=True)
    area_enchape = models.BooleanField(blank=True)
    area_lacado_madera = models.BooleanField(blank=True)
    area_arte = models.BooleanField(blank=True)
    area_cerrajeria = models.BooleanField(blank=True)
    area_fundicion = models.BooleanField(blank=True)
    area_matriceria = models.BooleanField(blank=True)
    area_lacado_hierro = models.BooleanField(blank=True)
    area_marmol = models.BooleanField(blank=True)
    area_espejos_vidrios = models.BooleanField(blank=True)
    area_tapiceria = models.BooleanField(blank=True)
    area_dimid = models.BooleanField(blank=True)
    area_pan_oro_plata = models.BooleanField(blank=True)
