...
url(
      ...
      url(r'^clientes/validarRucCliente/$','clientes.views.validarRucCliente',name='clientes-validar-ruc',),
      url(r'^clientes/validarRucRazonSocial/$','clientes.views.validarRucRazonSocial',name='razon-social-validar-ruc',),
